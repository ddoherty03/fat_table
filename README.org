...
#+RESULTS:
#+BEGIN_EXAMPLE
#<FatTable::Table:0x0055ba59415c08 @columns=[#<FatTable::Column:0x0055ba5940fa60 @raw_header=:ref, @header=:ref, @type="String", @items=["T003", "T003", "T017", "T018", "T018", "T006", "T007", "T014", "T015", "T015", "T016", "T019", "T020", "T021", "T021"]>, #<FatTable::Column:0x0055ba5940f358 @raw_header=:date, @header=:date, @type="DateTime", @items=[Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Wed, 02 Nov 2016, Wed, 02 Nov 2016, Wed, 02 Nov 2016, Wed, 02 Nov 2016, Sun, 15 Jan 2017, Thu, 19 Jan 2017, Mon, 23 Jan 2017, Mon, 23 Jan 2017]>, #<FatTable::Column:0x0055ba5940ea48 @raw_header=:code, @header=:code, @type="String", @items=["P", "P", "P", "S", "S", "S", "S", "P", "P", "P", "P", "S", "S", "P", "P"]>, #<FatTable::Column:0x0055ba5940e4d0 @raw_header=:price, @header=:price, @type="Numeric", @items=[7.5, 7.5, 8.3, 7.152, 7.152, 7.6, 7.65, 7.45, 7.75, 7.75, 8.25, 8.75, 8.25, 7.16, 7.16]>, #<FatTable::Column:0x0055ba5940de90 @raw_header=:g10, @header=:g10, @type="Boolean", @items=[false, false, false, true, true, false, true, false, false, false, true, true, false, true, true]>, #<FatTable::Column:0x0055ba5940dad0 @raw_header=:qp10, @header=:qp10, @type="Boolean", @items=[true, true, true, false, false, true, false, true, false, false, true, false, true, true, true]>, #<FatTable::Column:0x0055ba5940d710 @raw_header=:shares, @header=:shares, @type="Numeric", @items=[800, 800, 1801, 2516, 2516, 1000, 200, 5847, 500, 500, 100, 300, 700, 12100, 12100]>, #<FatTable::Column:0x0055ba5940d198 @raw_header=:lp, @header=:lp, @type="Numeric", @items=[112, 112, 1201, 2400, 2400, 143, 28, 835, 72, 72, 14, 175, 615, 11050, 11050]>, #<FatTable::Column:0x0055ba5940cc70 @raw_header=:qp, @header=:qp, @type="Numeric", @items=[688, 688, 600, 116, 116, 857, 172, 5012, 428, 428, 86, 125, 85, 1050, 1050]>, #<FatTable::Column:0x0055ba5940c720 @raw_header=:iplp, @header=:iplp, @type="Numeric", @items=[0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453]>, #<FatTable::Column:0x0055ba5940c108 @raw_header=:ipqp, @header=:ipqp, @type="Numeric", @items=[0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924]>], @boundaries=[2, 6, 10]>
#+END_EXAMPLE
