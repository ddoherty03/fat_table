...
#+RESULTS:
#+BEGIN_EXAMPLE
#<FatTable::Table:0x0056383c13ac70 @columns=[#<FatTable::Column:0x0056383c1393e8 @raw_header=:ref, @header=:ref, @type="String", @items=["T003", "T003", "T017", "T018", "T018", "T006", "T007", "T014", "T015", "T015", "T016", "T019", "T020", "T021", "T021"]>, #<FatTable::Column:0x0056383c138e48 @raw_header=:date, @header=:date, @type="DateTime", @items=[Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Tue, 01 Nov 2016, Wed, 02 Nov 2016, Wed, 02 Nov 2016, Wed, 02 Nov 2016, Wed, 02 Nov 2016, Sun, 15 Jan 2017, Thu, 19 Jan 2017, Mon, 23 Jan 2017, Mon, 23 Jan 2017]>, #<FatTable::Column:0x0056383c138150 @raw_header=:code, @header=:code, @type="String", @items=["P", "P", "P", "S", "S", "S", "S", "P", "P", "P", "P", "S", "S", "P", "P"]>, #<FatTable::Column:0x0056383c1138c8 @raw_header=:price, @header=:price, @type="Numeric", @items=[7.5, 7.5, 8.3, 7.152, 7.152, 7.6, 7.65, 7.45, 7.75, 7.75, 8.25, 8.75, 8.25, 7.16, 7.16]>, #<FatTable::Column:0x0056383c112e00 @raw_header=:g10, @header=:g10, @type="Boolean", @items=[false, false, false, true, true, false, true, false, false, false, true, true, false, true, true]>, #<FatTable::Column:0x0056383c112a18 @raw_header=:qp10, @header=:qp10, @type="Boolean", @items=[true, true, true, false, false, true, false, true, false, false, true, false, true, true, true]>, #<FatTable::Column:0x0056383c112388 @raw_header=:shares, @header=:shares, @type="Numeric", @items=[800, 800, 1801, 2516, 2516, 1000, 200, 5847, 500, 500, 100, 300, 700, 12100, 12100]>, #<FatTable::Column:0x0056383c111ac8 @raw_header=:lp, @header=:lp, @type="Numeric", @items=[112, 112, 1201, 2400, 2400, 143, 28, 835, 72, 72, 14, 175, 615, 11050, 11050]>, #<FatTable::Column:0x0056383c1110c8 @raw_header=:qp, @header=:qp, @type="Numeric", @items=[688, 688, 600, 116, 116, 857, 172, 5012, 428, 428, 86, 125, 85, 1050, 1050]>, #<FatTable::Column:0x0056383c1108a8 @raw_header=:iplp, @header=:iplp, @type="Numeric", @items=[0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453, 0.2453]>, #<FatTable::Column:0x0056383c527dd8 @raw_header=:ipqp, @header=:ipqp, @type="Numeric", @items=[0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924, 0.1924]>], @boundaries=[2, 6, 10]>
#+END_EXAMPLE
...
|------+------------+-------------------------------+------------+--------+--------+---------+----------+-----------+------------+------------|
| P    | 2016-11-01 | 7.607142857142857142857142857 |      17396 |   2473 |  14923 | T       | F        | T001      |     0.2453 |     0.1924 |
| P    | 2016-11-02 | 7.617857142857142857142857143 |      69047 |   9945 |  59102 | T       | F        | T011      |     0.2453 |     0.1924 |
| S    | 2016-11-01 |                          7.58 |      13011 |   1852 |  11159 | T       | F        | T004      |     0.2453 |     0.1924 |
#+END_EXAMPLE
