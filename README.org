...
you can decorate the output with group footers that summarize the columns in
each group.
...
**** Forcing String Type
Occasionally, the ~FatTable~'s automatic type detection can get in the way and
you just want it to treat one or more columns as Strings regardless of their
...
the only operations that mutate its receiver table.
...
+---------+-------+-----+------------+--------+---------------------+
| Average |       |  31 |            | 31,429 | 2005-12-29 17:08:34 |
+---------+-------+-----+------------+--------+---------------------+
|   Tally |       |   8 |            |        |                     |
+=========+=======+=====+============+========+=====================+
#+end_EXAMPLE
