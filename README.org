...
#+PROPERTY: header-args:ruby+ :prologue "load 'lib/fat_table.rb'" :eval yes
...
[![Build Status](https://github.com/ddoherty03/fat_table/actions/workflows/ruby-with-dbs.yml/badge.svg?branch=master)

The following is for org.
#+END_COMMENT

[[https://github.com/ddoherty03/fat_table/actions/workflows/ruby-with-dbs.yml][https://github.com/ddoherty03/fat_table/actions/workflows/ruby-with-dbs.yml/badge.svg?branch=master]]
...
#+begin_src ruby :results output :eval no
  puts "Current directory: #{Dir.pwd}"
  puts "Ruby LOADPATH:"
  $:.unshift("./lib") unless $:[0] == './lib'
  $:[0..10].each { |d| puts d }
  puts "..."
  load 'lib/fat_table.rb'  # => true
#+end_src

#+RESULTS:
#+begin_example
Current directory: /home/ded/src/fat_table
=> nil
Ruby LOADPATH:
=> nil
=> nil
...
...
=> nil
lib/fat_table.rb:43: warning: already initialized constant FatTable::FORMATS
/home/ded/src/fat_table/lib/fat_table.rb:43: warning: previous definition of FORMATS was here
=> true
:org_babel_ruby_eoe
#+end_example
...
|    Date    | Code |     Raw    |    Shares   |   Price  |   Info  | Ok |
+------------+------+------------+-------------+----------+---------+----+
| 2013-05-29 |   S  |  15700.000 |     6,601.9 | $24.7790 | ENTITY3 |  N |
| 2013-05-02 |   P  | 118186.400 |   118,186.4 |  11.8500 | ENTITY1 |  Y |
| 2013-05-20 |   S  |  12000.000 |     5,046.0 |  28.2804 | ENTITY3 |  N |
| 2013-05-23 |   S  |   8000.000 |     3,364.0 |  27.1083 | ENTITY3 |  Y |
| 2013-05-23 |   S  |  39906.000 |    16,780.5 |  25.1749 | ENTITY3 |  Y |
| 2013-05-20 |   S  |  85000.000 |    35,742.5 |  28.3224 | ENTITY3 |  Y |
| 2013-05-02 |   P  | 795546.200 |   795,546.2 |   1.1850 | ENTITY1 |  Y |
| 2013-05-29 |   S  |  13459.000 |     5,659.5 |  24.7464 | ENTITY3 |  Y |
| 2013-05-20 |   S  |  33302.000 |    14,003.5 |  28.6383 | ENTITY3 |  Y |
| 2013-05-29 |   S  |  15900.000 |     6,686.0 |  24.5802 | ENTITY3 |  Y |
| 2013-05-30 |   S  |   6679.000 |     2,808.5 |  25.0471 | ENTITY3 |  Y |
| 2013-05-23 |   S  |  23054.000 |     9,694.2 |  26.8015 | ENTITY3 |  N |
+------------+------+------------+-------------+----------+---------+----+
...
|------+------------+------+-------+--------|
| T001 | 2016-11-01 | P    | 8     |    100 |
| T002 | 2016-11-01 | P    | 8     |    200 |
| T003 | 2016-11-01 | P    | 8     |    800 |
| T004 | 2016-11-01 | S    | 8     |   6811 |
| T005 | 2025-12-13 | S    | 8     |   4000 |
| T006 | 2016-11-01 | S    | 8     |   1000 |
| T007 | 2016-11-01 | S    | 8     |    200 |
| T008 | 2016-11-01 | P    | 8     |   2771 |
| T009 | 2016-11-01 | P    | 8     |   9550 |
| T010 | 2016-11-01 | P    | 8     |   3175 |
| T011 | 2016-11-02 | P    | 7     |    100 |
| T012 | 2016-11-02 | P    | 8     |   4700 |
| T013 | 2016-11-02 | P    | 7     |  53100 |
| T014 | 2016-11-02 | P    | 7     |   5847 |
| T015 | 2016-11-02 | P    | 8     |    500 |
| T016 | 2016-11-02 | P    | 8     |    100 |
#+end_example
...
| Date       | Code | Raw        | Shares     | Price  | Info    | Ok |
+------------+------+------------+------------+--------+---------+----+
| 2013-05-29 | S    | 15700.000  | 6601.850   | 24.779 | ENTITY3 | F  |
| 2013-05-02 | P    | 118186.400 | 118186.400 | 11.850 | ENTITY1 | T  |
| 2013-05-20 | S    | 12000.000  | 5046.000   | 28.280 | ENTITY3 | F  |
| 2013-05-23 | S    | 8000.000   | 3364.000   | 27.108 | ENTITY3 | T  |
| 2013-05-23 | S    | 39906.000  | 16780.470  | 25.175 | ENTITY3 | T  |
| 2013-05-20 | S    | 85000.000  | 35742.500  | 28.322 | ENTITY3 | T  |
| 2013-05-02 | P    | 795546.200 | 795546.200 | 1.185  | ENTITY1 | T  |
| 2013-05-29 | S    | 13459.000  | 5659.510   | 24.746 | ENTITY3 | T  |
| 2013-05-20 | S    | 33302.000  | 14003.490  | 28.638 | ENTITY3 | T  |
| 2013-05-29 | S    | 15900.000  | 6685.950   | 24.580 | ENTITY3 | T  |
| 2013-05-30 | S    | 6679.000   | 2808.520   | 25.047 | ENTITY3 | T  |
| 2013-05-23 | S    | 23054.000  | 9694.210   | 26.802 | ENTITY3 | F  |
+============+======+============+============+========+=========+====+
#+end_example
...
#+BEGIN_SRC ruby :wrap EXAMPLE
  ...
  tab1.to_aoa # {|f| f.format(price: '0.4', iplp: '0.4', ipqp: '0.4', shares:',') }
#+END_SRC
...
| Ref  | Date       | Code | Price | G10 | QP10 | Shares |    Lp |   Qp | Iplp | Ipqp |
|------+------------+------+-------+-----+------+--------+-------+------+------+------|
| T003 | 2016-11-01 | P    | 8     | F   | T    |    800 |   112 |  688 | 0    | 0    |
| T003 | 2016-11-01 | P    | 8     | F   | T    |    800 |   112 |  688 | 0    | 0    |
| T017 | 2016-11-01 | P    | 8     | F   | T    |   1801 |  1201 |  600 | 0    | 0    |
|------+------------+------+-------+-----+------+--------+-------+------+------+------|
| T018 | 2016-11-01 | S    | 7     | T   | F    |   2516 |  2400 |  116 | 0    | 0    |
| T018 | 2016-11-01 | S    | 7     | T   | F    |   2516 |  2400 |  116 | 0    | 0    |
| T006 | 2016-11-01 | S    | 8     | F   | T    |   1000 |   143 |  857 | 0    | 0    |
| T007 | 2016-11-01 | S    | 8     | T   | F    |    200 |    28 |  172 | 0    | 0    |
|------+------------+------+-------+-----+------+--------+-------+------+------+------|
| T014 | 2016-11-02 | P    | 7     | F   | T    |   5847 |   835 | 5012 | 0    | 0    |
| T015 | 2016-11-02 | P    | 8     | F   | F    |    500 |    72 |  428 | 0    | 0    |
| T015 | 2016-11-02 | P    | 8     | F   | F    |    500 |    72 |  428 | 0    | 0    |
| T016 | 2016-11-02 | P    | 8     | T   | T    |    100 |    14 |   86 | 0    | 0    |
|------+------------+------+-------+-----+------+--------+-------+------+------+------|
| T019 | 2017-01-15 | S    | 9     | T   | F    |    300 |   175 |  125 | 0    | 0    |
| T020 | 2017-01-19 | S    | 8     | F   | T    |    700 |   615 |   85 | 0    | 0    |
| T021 | 2017-01-23 | P    | 7     | T   | T    |  12100 | 11050 | 1050 | 0    | 0    |
| T021 | 2017-01-23 | P    | 7     | T   | T    |  12100 | 11050 | 1050 | 0    | 0    |
#+end_EXAMPLE
...
|------+------------+------+-------+-----+------+--------+------+-------+-------+-------+------------|
| T001 | 2016-11-01 | P    | 7.700 | T   | F    |    100 |   14 |    86 | 0.245 | 0.192 |    770.000 |
| T002 | 2016-11-01 | P    | 7.750 | T   | F    |    200 |   28 |   172 | 0.245 | 0.192 |   1550.000 |
| T003 | 2016-11-01 | P    | 7.500 | F   | T    |    800 |  112 |   688 | 0.245 | 0.192 |   6000.000 |
| T003 | 2016-11-01 | P    | 7.500 | F   | T    |    800 |  112 |   688 | 0.245 | 0.192 |   6000.000 |
|------+------------+------+-------+-----+------+--------+------+-------+-------+-------+------------|
| T004 | 2016-11-01 | S    | 7.550 | T   | F    |   6811 |  966 |  5845 | 0.245 | 0.192 |  51423.050 |
| T005 | 2016-11-01 | S    | 7.500 | F   | F    |   4000 |  572 |  3428 | 0.245 | 0.192 |  30000.000 |
| T006 | 2016-11-01 | S    | 7.600 | F   | T    |   1000 |  143 |   857 | 0.245 | 0.192 |   7600.000 |
| T006 | 2016-11-01 | S    | 7.600 | F   | T    |   1000 |  143 |   857 | 0.245 | 0.192 |   7600.000 |
| T007 | 2016-11-01 | S    | 7.650 | T   | F    |    200 |   28 |   172 | 0.245 | 0.192 |   1530.000 |
| T008 | 2016-11-01 | P    | 7.650 | F   | F    |   2771 |  393 |  2378 | 0.245 | 0.192 |  21198.150 |
| T009 | 2016-11-01 | P    | 7.600 | F   | F    |   9550 | 1363 |  8187 | 0.245 | 0.192 |  72580.000 |
|------+------------+------+-------+-----+------+--------+------+-------+-------+-------+------------|
| T010 | 2016-11-01 | P    | 7.550 | F   | T    |   3175 |  451 |  2724 | 0.245 | 0.192 |  23971.250 |
| T011 | 2016-11-02 | P    | 7.425 | T   | F    |    100 |   14 |    86 | 0.245 | 0.192 |    742.500 |
| T012 | 2016-11-02 | P    | 7.550 | F   | F    |   4700 |  677 |  4023 | 0.245 | 0.192 |  35485.000 |
| T012 | 2016-11-02 | P    | 7.550 | F   | F    |   4700 |  677 |  4023 | 0.245 | 0.192 |  35485.000 |
| T013 | 2016-11-02 | P    | 7.350 | T   | T    |  53100 | 7656 | 45444 | 0.245 | 0.192 | 390285.000 |
|------+------------+------+-------+-----+------+--------+------+-------+-------+-------+------------|
| T014 | 2016-11-02 | P    | 7.450 | F   | T    |   5847 |  835 |  5012 | 0.245 | 0.192 |  43560.150 |
| T015 | 2016-11-02 | P    | 7.750 | F   | F    |    500 |   72 |   428 | 0.245 | 0.192 |   3875.000 |
| T016 | 2016-11-02 | P    | 8.250 | T   | T    |    100 |   14 |    86 | 0.245 | 0.192 |    825.000 |
#+end_EXAMPLE
...
|------+------------+------+-------+--------|
| T001 | 2016-11-01 | P    | 7.700 |    100 |
| T002 | 2016-11-01 | P    | 7.750 |    200 |
| T003 | 2016-11-01 | P    | 7.500 |    800 |
| T003 | 2016-11-01 | P    | 7.500 |    800 |
|------+------------+------+-------+--------|
| T004 | 2016-11-01 | S    | 7.550 |   6811 |
| T005 | 2016-11-01 | S    | 7.500 |   4000 |
| T006 | 2016-11-01 | S    | 7.600 |   1000 |
| T006 | 2016-11-01 | S    | 7.600 |   1000 |
| T007 | 2016-11-01 | S    | 7.650 |    200 |
| T008 | 2016-11-01 | P    | 7.650 |   2771 |
| T009 | 2016-11-01 | P    | 7.600 |   9550 |
|------+------------+------+-------+--------|
| T010 | 2016-11-01 | P    | 7.550 |   3175 |
| T011 | 2016-11-02 | P    | 7.425 |    100 |
| T012 | 2016-11-02 | P    | 7.550 |   4700 |
| T012 | 2016-11-02 | P    | 7.550 |   4700 |
| T013 | 2016-11-02 | P    | 7.350 |  53100 |
|------+------------+------+-------+--------|
| T014 | 2016-11-02 | P    | 7.450 |   5847 |
| T015 | 2016-11-02 | P    | 7.750 |    500 |
| T016 | 2016-11-02 | P    | 8.250 |    100 |
#+end_EXAMPLE
...
|------+-------+--------+------------+------------|
| T001 | 7.700 |    100 | 2016-11-01 |    770.000 |
| T002 | 7.750 |    200 | 2016-11-01 |   1550.000 |
| T003 | 7.500 |    800 | 2016-11-01 |   6000.000 |
| T003 | 7.500 |    800 | 2016-11-01 |   6000.000 |
|------+-------+--------+------------+------------|
| T004 | 7.550 |   6811 | 2016-11-01 |  51423.050 |
| T005 | 7.500 |   4000 | 2016-11-01 |  30000.000 |
| T006 | 7.600 |   1000 | 2016-11-01 |   7600.000 |
| T006 | 7.600 |   1000 | 2016-11-01 |   7600.000 |
| T007 | 7.650 |    200 | 2016-11-01 |   1530.000 |
| T008 | 7.650 |   2771 | 2016-11-01 |  21198.150 |
| T009 | 7.600 |   9550 | 2016-11-01 |  72580.000 |
|------+-------+--------+------------+------------|
| T010 | 7.550 |   3175 | 2016-11-01 |  23971.250 |
| T011 | 7.425 |    100 | 2016-11-02 |    742.500 |
| T012 | 7.550 |   4700 | 2016-11-02 |  35485.000 |
| T012 | 7.550 |   4700 | 2016-11-02 |  35485.000 |
| T013 | 7.350 |  53100 | 2016-11-02 | 390285.000 |
|------+-------+--------+------------+------------|
| T014 | 7.450 |   5847 | 2016-11-02 |  43560.150 |
| T015 | 7.750 |    500 | 2016-11-02 |   3875.000 |
| T016 | 8.250 |    100 | 2016-11-02 |    825.000 |
#+end_EXAMPLE
...
|------+------------+-------+--------+------------|
| T001 | 2016-11-01 | 7.700 |    100 |    770.000 |
| T002 | 2016-11-01 | 7.750 |    200 |   1550.000 |
| T003 | 2016-11-01 | 7.500 |    800 |   6000.000 |
| T003 | 2016-11-01 | 7.500 |    800 |   6000.000 |
|------+------------+-------+--------+------------|
| T004 | 2016-11-01 | 7.550 |   6811 |  51423.050 |
| T005 | 2016-11-01 | 7.500 |   4000 |  30000.000 |
| T006 | 2016-11-01 | 7.600 |   1000 |   7600.000 |
| T006 | 2016-11-01 | 7.600 |   1000 |   7600.000 |
| T007 | 2016-11-01 | 7.650 |    200 |   1530.000 |
| T008 | 2016-11-01 | 7.650 |   2771 |  21198.150 |
| T009 | 2016-11-01 | 7.600 |   9550 |  72580.000 |
|------+------------+-------+--------+------------|
| T010 | 2016-11-01 | 7.550 |   3175 |  23971.250 |
| T011 | 2016-11-02 | 7.425 |    100 |    742.500 |
| T012 | 2016-11-02 | 7.550 |   4700 |  35485.000 |
| T012 | 2016-11-02 | 7.550 |   4700 |  35485.000 |
| T013 | 2016-11-02 | 7.350 |  53100 | 390285.000 |
|------+------------+-------+--------+------------|
| T014 | 2016-11-02 | 7.450 |   5847 |  43560.150 |
| T015 | 2016-11-02 | 7.750 |    500 |   3875.000 |
| T016 | 2016-11-02 | 8.250 |    100 |    825.000 |
#+end_EXAMPLE
...
| Ref  | Traded On  | Price | Shares | Cost                 |
|------+------------+-------+--------+----------------------|
| T001 | 2016-11-01 | 7.700 |    100 | the price of freedom |
| T002 | 2016-11-01 | 7.750 |    200 | the price of freedom |
| T003 | 2016-11-01 | 7.500 |    800 | the price of freedom |
| T003 | 2016-11-01 | 7.500 |    800 | the price of freedom |
|------+------------+-------+--------+----------------------|
| T004 | 2016-11-01 | 7.550 |   6811 | the price of freedom |
| T005 | 2016-11-01 | 7.500 |   4000 | the price of freedom |
| T006 | 2016-11-01 | 7.600 |   1000 | the price of freedom |
| T006 | 2016-11-01 | 7.600 |   1000 | the price of freedom |
| T007 | 2016-11-01 | 7.650 |    200 | the price of freedom |
| T008 | 2016-11-01 | 7.650 |   2771 | the price of freedom |
| T009 | 2016-11-01 | 7.600 |   9550 | the price of freedom |
|------+------------+-------+--------+----------------------|
| T010 | 2016-11-01 | 7.550 |   3175 | the price of freedom |
| T011 | 2016-11-02 | 7.425 |    100 | the price of freedom |
| T012 | 2016-11-02 | 7.550 |   4700 | the price of freedom |
| T012 | 2016-11-02 | 7.550 |   4700 | the price of freedom |
| T013 | 2016-11-02 | 7.350 |  53100 | the price of freedom |
|------+------------+-------+--------+----------------------|
| T014 | 2016-11-02 | 7.450 |   5847 | the price of freedom |
| T015 | 2016-11-02 | 7.750 |    500 | the price of freedom |
| T016 | 2016-11-02 | 8.250 |    100 | the price of freedom |
#+end_example
...
|------+------------+-------+--------+-------+------------|
| T001 | 2016-11-01 | 7.700 |    100 | 3.142 | 2025-12-13 |
| T002 | 2016-11-01 | 7.750 |    200 | 3.142 | 2025-12-13 |
| T003 | 2016-11-01 | 7.500 |    800 | 3.142 | 2025-12-13 |
| T003 | 2016-11-01 | 7.500 |    800 | 3.142 | 2025-12-13 |
|------+------------+-------+--------+-------+------------|
| T004 | 2016-11-01 | 7.550 |   6811 | 3.142 | 2025-12-13 |
| T005 | 2016-11-01 | 7.500 |   4000 | 3.142 | 2025-12-13 |
| T006 | 2016-11-01 | 7.600 |   1000 | 3.142 | 2025-12-13 |
| T006 | 2016-11-01 | 7.600 |   1000 | 3.142 | 2025-12-13 |
| T007 | 2016-11-01 | 7.650 |    200 | 3.142 | 2025-12-13 |
| T008 | 2016-11-01 | 7.650 |   2771 | 3.142 | 2025-12-13 |
| T009 | 2016-11-01 | 7.600 |   9550 | 3.142 | 2025-12-13 |
|------+------------+-------+--------+-------+------------|
| T010 | 2016-11-01 | 7.550 |   3175 | 3.142 | 2025-12-13 |
| T011 | 2016-11-02 | 7.425 |    100 | 3.142 | 2025-12-13 |
| T012 | 2016-11-02 | 7.550 |   4700 | 3.142 | 2025-12-13 |
| T012 | 2016-11-02 | 7.550 |   4700 | 3.142 | 2025-12-13 |
| T013 | 2016-11-02 | 7.350 |  53100 | 3.142 | 2025-12-13 |
|------+------------+-------+--------+-------+------------|
| T014 | 2016-11-02 | 7.450 |   5847 | 3.142 | 2025-12-13 |
| T015 | 2016-11-02 | 7.750 |    500 | 3.142 | 2025-12-13 |
| T016 | 2016-11-02 | 8.250 |    100 | 3.142 | 2025-12-13 |
#+end_example
...
│ Ref  │ Date       │ Code │ Price │ G10 │ QP10 │ Shares │ Lp   │ Qp    │ Iplp │ Ipqp │
├──────┼────────────┼──────┼───────┼─────┼──────┼────────┼──────┼───────┼──────┼──────┤
│ T002 │ 2016-11-01 │ P    │ 8     │ T   │ F    │ 200    │ 28   │ 172   │ 0    │ 0    │
│ T003 │ 2016-11-01 │ P    │ 8     │ F   │ T    │ 800    │ 112  │ 688   │ 0    │ 0    │
│ T006 │ 2016-11-01 │ S    │ 8     │ F   │ T    │ 1000   │ 143  │ 857   │ 0    │ 0    │
│ T010 │ 2016-11-01 │ P    │ 8     │ F   │ T    │ 3175   │ 451  │ 2724  │ 0    │ 0    │
│ T013 │ 2016-11-02 │ P    │ 7     │ T   │ T    │ 53100  │ 7656 │ 45444 │ 0    │ 0    │
╘══════╧════════════╧══════╧═══════╧═════╧══════╧════════╧══════╧═══════╧══════╧══════╛
#+end_example
...
| Ref  | Date       | Code | Price | G10 | QP10 | Shares |   Lp |    Qp | Iplp | Ipqp |
|------+------------+------+-------+-----+------+--------+------+-------+------+------|
| T011 | 2016-11-02 | P    | 7     | T   | F    |    100 |   14 |    86 | 0    | 0    |
| T012 | 2016-11-02 | P    | 8     | F   | F    |   4700 |  677 |  4023 | 0    | 0    |
| T012 | 2016-11-02 | P    | 8     | F   | F    |   4700 |  677 |  4023 | 0    | 0    |
| T013 | 2016-11-02 | P    | 7     | T   | T    |  53100 | 7656 | 45444 | 0    | 0    |
| T014 | 2016-11-02 | P    | 7     | F   | T    |   5847 |  835 |  5012 | 0    | 0    |
| T015 | 2016-11-02 | P    | 8     | F   | F    |    500 |   72 |   428 | 0    | 0    |
| T016 | 2016-11-02 | P    | 8     | T   | T    |    100 |   14 |    86 | 0    | 0    |
|------+------------+------+-------+-----+------+--------+------+-------+------+------|
| T001 | 2016-11-01 | P    | 8     | T   | F    |    100 |   14 |    86 | 0    | 0    |
| T002 | 2016-11-01 | P    | 8     | T   | F    |    200 |   28 |   172 | 0    | 0    |
| T003 | 2016-11-01 | P    | 8     | F   | T    |    800 |  112 |   688 | 0    | 0    |
| T003 | 2016-11-01 | P    | 8     | F   | T    |    800 |  112 |   688 | 0    | 0    |
| T008 | 2016-11-01 | P    | 8     | F   | F    |   2771 |  393 |  2378 | 0    | 0    |
| T009 | 2016-11-01 | P    | 8     | F   | F    |   9550 | 1363 |  8187 | 0    | 0    |
| T010 | 2016-11-01 | P    | 8     | F   | T    |   3175 |  451 |  2724 | 0    | 0    |
|------+------------+------+-------+-----+------+--------+------+-------+------+------|
| T004 | 2016-11-01 | S    | 8     | T   | F    |   6811 |  966 |  5845 | 0    | 0    |
| T005 | 2016-11-01 | S    | 8     | F   | F    |   4000 |  572 |  3428 | 0    | 0    |
| T006 | 2016-11-01 | S    | 8     | F   | T    |   1000 |  143 |   857 | 0    | 0    |
| T006 | 2016-11-01 | S    | 8     | F   | T    |   1000 |  143 |   857 | 0    | 0    |
| T007 | 2016-11-01 | S    | 8     | T   | F    |    200 |   28 |   172 | 0    | 0    |
#+end_example
...
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T011 | 2016-11-02 | P    | 7     | T   | F    |    100 |   14 |    86 | 0    | 0    |      743 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T001 | 2016-11-01 | P    | 8     | T   | F    |    100 |   14 |    86 | 0    | 0    |      770 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T016 | 2016-11-02 | P    | 8     | T   | T    |    100 |   14 |    86 | 0    | 0    |      825 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T007 | 2016-11-01 | S    | 8     | T   | F    |    200 |   28 |   172 | 0    | 0    |     1530 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T002 | 2016-11-01 | P    | 8     | T   | F    |    200 |   28 |   172 | 0    | 0    |     1550 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T015 | 2016-11-02 | P    | 8     | F   | F    |    500 |   72 |   428 | 0    | 0    |     3875 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T003 | 2016-11-01 | P    | 8     | F   | T    |    800 |  112 |   688 | 0    | 0    |     6000 |
| T003 | 2016-11-01 | P    | 8     | F   | T    |    800 |  112 |   688 | 0    | 0    |     6000 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T006 | 2016-11-01 | S    | 8     | F   | T    |   1000 |  143 |   857 | 0    | 0    |     7600 |
| T006 | 2016-11-01 | S    | 8     | F   | T    |   1000 |  143 |   857 | 0    | 0    |     7600 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T008 | 2016-11-01 | P    | 8     | F   | F    |   2771 |  393 |  2378 | 0    | 0    |    21198 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T010 | 2016-11-01 | P    | 8     | F   | T    |   3175 |  451 |  2724 | 0    | 0    |    23971 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T005 | 2016-11-01 | S    | 8     | F   | F    |   4000 |  572 |  3428 | 0    | 0    |    30000 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T012 | 2016-11-02 | P    | 8     | F   | F    |   4700 |  677 |  4023 | 0    | 0    |    35485 |
| T012 | 2016-11-02 | P    | 8     | F   | F    |   4700 |  677 |  4023 | 0    | 0    |    35485 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T014 | 2016-11-02 | P    | 7     | F   | T    |   5847 |  835 |  5012 | 0    | 0    |    43560 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T004 | 2016-11-01 | S    | 8     | T   | F    |   6811 |  966 |  5845 | 0    | 0    |    51423 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T009 | 2016-11-01 | P    | 8     | F   | F    |   9550 | 1363 |  8187 | 0    | 0    |    72580 |
|------+------------+------+-------+-----+------+--------+------+-------+------+------+----------|
| T013 | 2016-11-02 | P    | 7     | T   | T    |  53100 | 7656 | 45444 | 0    | 0    |   390285 |
#+end_example
