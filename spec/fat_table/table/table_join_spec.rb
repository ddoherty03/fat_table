module FatTable
  RSpec.describe Table do
    describe 'join' do
      ...
      it 'is able to do an inner join' do
        ...
        expect(join_tab.headers).to eq([:id, :name, :age, :address, :salary, :join_date, :id_b, :dept])
      end

      it 'is able to do an inner join on a string exp' do
        join_tab = tab_a.join(tab_b, 'id_a == emp_id_b')
        expect(join_tab.class).to eq Table
        expect(join_tab.size).to eq(2)
        expect(join_tab[:name]).to include('Paul')
        expect(join_tab[:name]).to include('Allen')
        expect(join_tab.headers).to eq([:id, :name, :age, :address, :salary, :join_date, :id_b, :dept, :emp_id])
      end

      it 'is able to do a left join' do
      ...
      it 'is able to do a right join' do
      ...
      it 'is able to do a full join' do
      ...
      it 'is able to do a cross join' do
